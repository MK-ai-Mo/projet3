...
<button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div class="Contact">
      <div class="container">
        <div class="row">
          <h1 id="idcontact" class="titreh1">CONTACT</h1>
          <div class="cardfone">
            <div class="phone">
            ...
            <div class="gmail">
              ...
              <p>mouchtak35@gmail.com</p>
  
            </div>
            <div class="address">
              <span><i class="fa-solid fa-location-dot"></i> ADDRESS</span>
              <p>Casablanca ain sbaa</p>
            </div>
          </div>
          <form onsubmit="return validateForm()" id="form" class="inscrip">
            <div id="ereur" class="input">
              <input id="name" name="name" type="text" placeholder="Name" >
              <input id="email" name="email" type="email" placeholder="Email">
              <input id="texttel" name="location" type="tel" placeholder="Phone">
            </div>

            <div class="textarea">
              <input id="mesage" name="message" class="inp" type="text" placeholder="Message">          
              <input id="textsubmit" class="sinp" type="submit" value="Message">
          </div>
          </form>       
    ...
    <script>
      ...
      function validateForm() {
                  ...
                  if (name === "") {
                      alert("Please fill in the in the name field");
                      return false;
                  }
