        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form  class="d-flex gap-1" role="search">
              ...
              <button id="formbtn"  class="btn btn-outline-warning d-flex" type="submit">Search</button>
    ...
    <form action="">
      <div class="container" id="login">
        <div class="row">
            ...
            <div class="col-md-7 py-md-0" id="side2">
          ...
          <div class="container mb-5" id="newslater">
            <h3 class="text-center">Subscribe To The Electronic Shop For Latest upload.</h3>
            <div class="input text-center">
              <input class="mailinp" type="text" placeholder="Enter Your Email..">
