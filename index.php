...
$select = "SELECT * FROM `produit` LIMIT 6";
...
?>
     ...
     <!-- star main -->
      <div class="main">
        <div class="container">
          <div class="row">
            <div id="divlors" >
              <h1><span class="spanE">E</span>lectronic Gadget <br>UP TO <span class="spanE">50%</span>off</h1>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ducimus minus eaque dignissimos error dolor</p>
    ...
    <div class="main">
      <div class="container">
        <div class="row">
          <div id="divlors" >
            <h1><span class="spanE">E</span>lectronic Products <br>UP TO <span class="spanE">50%</span>off</h1>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ducimus minus eaque dignissimos error dolor</p>
            <button class="btn btn-outline-warning">Shop Now</button>
          </div>
